...
public sealed class GigaHertz : Frequency
{
    ...
    public static implicit operator Hertz(GigaHertz x)
    {
        return new Hertz(x);
    }
    
    public static implicit operator KiloHertz(GigaHertz x)
    {
        return new KiloHertz(x);
    }
    
    public static implicit operator MegaHertz(GigaHertz x)
    {
        return new MegaHertz(x);
    }
    
    public static implicit operator TeraHertz(GigaHertz x)
    {

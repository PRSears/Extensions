...
public sealed class Fahrenheit : Temperature
{
    ...
    /// </summary>
    /// <param name="value"></param>
    public Fahrenheit(int value) { Value = value; }

    /// <summary>
    /// 
    /// </summary>
    /// <param name="value"></param>
    public Fahrenheit(Temperature value) { SiValue = value.SiValue; }
    ...
    /// </summary>
    public static implicit operator Fahrenheit(Kelvin x) { return x.ConvertTo<Fahrenheit>(); }

    /// <summary>
    /// Implicit conversion from Fahrenheit to Kelvin.
    /// </summary>
    public static implicit operator Kelvin(Fahrenheit x) { return x.ConvertTo<Kelvin>(); }
